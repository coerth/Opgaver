...
public class Die { // min klasse 'die'
  color eyeColor;
  color dieColor;
  int eyes; //min attribut hedder eyes
  int xPosDie = -110; //hurtig løsning på at ændre den første ternings position mere til venstre
  int yPosDie =10;
  int dieSize = 100;
