...
//implemteringen af interfaceet medgøre at der nu kommer en "int compareTo" metode i classen  
  color eyeColor;
  color dieColor;
  ...
  void DrawDie(int xPosDie, int yPosDie) {
   ...
   public int compareTo(Die otherDie) { // benyttes af sort metoden, via Comparable interfaceet
      ...
      // i forhold til sort betyder negativ at denne Die placeres til venstre og ved 0 eller positiv til højre
    }
}
