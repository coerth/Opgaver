...
public class Controller {
    ...
    public void endgameScreen(){
        displayGameScreen("Game Over!",0.3f, 40);
    ...
    public void startGameScreen(){
        displayGameScreen("Press Enter to start", 0.4f,40 );
        displayGameScreen("Press S for settings", 0.8f,20 );
    }
    ...
    public void settings(){
        ...
        displayGameScreen("3. Easy",0.6f, 20);
        settingsOptions();
    }
