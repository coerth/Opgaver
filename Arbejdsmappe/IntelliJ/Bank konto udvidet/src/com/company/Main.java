...
public class Main {
    ...
    public static void showMenu() {
        ArrayList<String> nameinputted = new ArrayList<String>();
        String choice;
        ...
        do {
            ...
            if(choice.equals("Slet") || choice.equals("slet") ){
                do{
                    if(nameinputted.size() == 0){
                        System.out.println("Skriv navnet på kontoens ejer:");
                        Scanner scan = new Scanner(System.in);
                        nameinputted.add(scan.nextLine() );
                        ...
                        nameinputted.add(choice);
                        System.out.println("Navnet er tilføjet til sletningen.");
                    } // else klemme
                }while(!choice.equals("bekræft sletning") );
                for(String names : nameinputted){
                    deleteAccount(names);
                } //for klemme
                nameinputted.clear();
            } // if slet klemme
            ...
            if(choice.equals("Trans") || choice.equals("trans") ) {
                ...
                moveMoney(money, nameinputted.get(0), nameinputted.get(1));                                             //kør funktionen moveMoney, den første plads i arrayet er altid hvor pengene kommer fra og den næste er den som modtager
                nameinputted.clear();                                                                                   //clear arraylisten med søgenavne så den ikke bliver evigt større
    ...
    private static void deleteAccount(String owner){                                                                     //funktion for at lede BankAccountArray igennem og slette det objekt som har samme navn som owner
